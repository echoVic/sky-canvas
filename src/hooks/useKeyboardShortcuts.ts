...
import { useDrawingTools, type ToolType } from './useDrawingTools';
...
export function useKeyboardShortcuts(
  ...
  const shortcuts: ShortcutConfig[] = [
    ...
    { key: 'z', ctrlKey: true, shiftKey: true, action: actions.redo, description: '重做', category: 'edit' },
    { key: 'z', metaKey: true, shiftKey: true, action: actions.redo, description: '重做 (Mac)', category: 'edit' },
    ...
    // 图层快捷键
    { key: ']', ctrlKey: true, action: actions.bringToFront, description: '置顶', category: 'layer' },
