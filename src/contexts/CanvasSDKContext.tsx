...
import { useCanvasSDK, type CanvasSDKState, type CanvasSDKActions } from '../hooks/useCanvasSDK';
...
export function CanvasProvider({ children, config }: CanvasProviderProps) {
  ...
  // 当 canvas 元素可用时自动初始化
  const initializeCanvas = useCallback(async (canvas: HTMLCanvasElement) => {
