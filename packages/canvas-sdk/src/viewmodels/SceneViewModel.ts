...
import type { IShapeRepository } from '../models/repositories/IShapeRepository'
import type { ISceneState, ISceneViewModel } from './interfaces/IViewModel'

export class SceneViewModel implements ISceneViewModel {
  private readonly _state: ISceneState

  constructor(private shapeRepository: IShapeRepository) {
  ...
  private handleRepositoryEvent(event: {
