...
import type { IRepositoryEvent, IShapeRepository } from '../../models/repositories/IShapeRepository'
...
export class CanvasViewModel {
  ...
  getSelectedShapes(): ShapeEntity[] {
    return this.state.shapes.filter((shape) => this.state.selectedShapes.includes(shape.id))
  }
