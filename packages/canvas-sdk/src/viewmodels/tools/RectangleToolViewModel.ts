...
import { type IRectangleEntity, ShapeEntityFactory } from '../../models/entities/Shape'
...
export const IRectangleToolViewModel =
  createDecorator<IRectangleToolViewModel>('RectangleToolViewModel')
