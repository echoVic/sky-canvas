...
import {
  ...
  type IInitialShapeState,
  type ISelectToolState as ISelectToolStateType,
  type ISelectToolViewModel as ISelectToolViewModelType,
...
export class SelectToolViewModel implements ISelectToolViewModelType {
  ...
  private performMarqueeSelect(bounds: {
    x: number
    y: number
    width: number
    height: number
