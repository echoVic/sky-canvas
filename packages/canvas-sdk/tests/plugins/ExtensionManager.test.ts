...
// 创建测试扩展点声明
function createTestExtensionPoint(
  id: string,
  overrides: Partial<ExtensionPointDeclaration> = {}
...
describe('ExtensionManager', () => {
  ...
  describe('事件系统', () => {
    ...
    it('应该触发扩展点定义事件', () => {
      ...
      expect(definedSpy).toHaveBeenCalledWith('new-point', expect.objectContaining(extensionPoint))
    })
