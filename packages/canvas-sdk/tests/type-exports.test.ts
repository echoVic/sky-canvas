...
// 测试类型导入
import type { ICanvasManager, ISceneManager, IToolManager } from '../src/managers'
// 测试值导入（装饰器）
import {
  ICanvasManager as ICanvasManagerDecorator,
  ISceneManager as ISceneManagerDecorator,
} from '../src/managers'
