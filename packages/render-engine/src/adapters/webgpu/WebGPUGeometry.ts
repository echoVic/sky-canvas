...
export class WebGPUGeometry {
  ...
  static createPolyline(
    ...
    for (let i = 0; i < actualPoints.length - 1; i++) {
      ...
      // 添加索引
      indices.push(baseIndex, baseIndex + 1, baseIndex + 3, baseIndex, baseIndex + 3, baseIndex + 2)
    }
  ...
  static createTriangle(
    ...
    const vertices = new Float32Array([x1, y1, r, g, b, a, x2, y2, r, g, b, a, x3, y3, r, g, b, a])
