...
import { type PooledTexture, type TextureConfig, TextureFormat } from './TextureTypes'
...
export class PooledTextureImpl implements PooledTexture {
  ...
  constructor(gl: WebGLRenderingContext, id: string, texture: WebGLTexture, config: TextureConfig) {
    this.gl = gl
    this.id = id
