...
import type { IRenderEngine, IViewport } from '../core/IRenderEngine'
import type { IGraphicsContext, IRect } from '../graphics/IGraphicsContext'
import type { IRenderCommand } from './IRenderCommand'
import { type IRenderQueue, type IRenderQueueConfig, RenderQueue } from './RenderQueue'
...
export class CommandRendererFactory {
  ...
  static create(config?: Partial<IRenderQueueConfig>): ICommandRenderer {
    return new CommandRenderer({
      ...CommandRendererFactory.defaultConfig,
      ...config,
    })
  }
  ...
  static setDefaultConfig(config: Partial<IRenderQueueConfig>): void {
    Object.assign(CommandRendererFactory.defaultConfig, config)
  }
}
