...
describe('RenderQueue', () => {
  describe('Given a RenderCommandBatch', () => {
    let renderBatch: RenderCommandBatch;
    ...
    beforeEach(() => {
      ...
      renderBatch = new RenderCommandBatch(materialKey, commandType);
    ...
    describe('When creating a new RenderCommandBatch', () => {
      it('Then it should initialize with correct properties', () => {
        // Arrange & Act
        const batch = new RenderCommandBatch(materialKey, commandType);
      ...
      it('Then it should generate unique IDs for different batches', () => {
        // Arrange & Act
        const batch1 = new RenderCommandBatch(materialKey, commandType);
        const batch2 = new RenderCommandBatch(materialKey, commandType);
    ...
    describe('When adding commands to RenderCommandBatch', () => {
    ...
    describe('When executing RenderCommandBatch', () => {
      beforeEach(() => {
    ...
    describe('When getting RenderCommandBatch statistics', () => {
      beforeEach(() => {
        // Arrange: Add commands to batch
        mockCommands.forEach(cmd => renderBatch.addCommand(cmd));
      });
