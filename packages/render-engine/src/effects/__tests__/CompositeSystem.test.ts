...
describe('复合操作系统', () => {
  ...
  describe('工具函数', () => {
    ...
    it('应该提供复合操作分类', () => {
      expect(getCompositeOperationCategory(CompositeOperation.SOURCE_OVER)).toBe(
        CompositeCategory.SOURCE
      )
      expect(getCompositeOperationCategory(CompositeOperation.DESTINATION_OVER)).toBe(
        CompositeCategory.DESTINATION
      )
      expect(getCompositeOperationCategory(CompositeOperation.LIGHTER)).toBe(
        CompositeCategory.SPECIAL
      )
      expect(getCompositeOperationCategory(CompositeOperation.MULTIPLY)).toBe(
        CompositeCategory.BLEND
      )
    })
