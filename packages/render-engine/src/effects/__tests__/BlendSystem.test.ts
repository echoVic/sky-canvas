...
describe('混合系统', () => {
  ...
  describe('BlendManager', () => {
    ...
    it('应该能够混合图层', () => {
      ...
      const normalOp = createBlendOperation(BlendMode.NORMAL, { mode: BlendMode.NORMAL, opacity: 1, enabled: true });
      const multiplyOp = createBlendOperation(BlendMode.MULTIPLY, { mode: BlendMode.MULTIPLY, opacity: 0.8, enabled: true });
