  ...
  protected compositePixel(
    ...
    return {
      r:
        alpha === 0
          ? 0
          : (src.r * dest.r * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (src.g * dest.g * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (src.b * dest.b * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }
  ...
  protected compositePixel(
    ...
    return {
      r:
        alpha === 0
          ? 0
          : (screenR * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (screenG * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (screenB * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }
...
export class OverlayComposite extends BaseCompositeOperation {
  ...
  protected compositePixel(
    ...
    const overlayR = dest.r < 0.5 ? 2 * dest.r * src.r : 1 - 2 * (1 - dest.r) * (1 - src.r)
    const overlayG = dest.g < 0.5 ? 2 * dest.g * src.g : 1 - 2 * (1 - dest.g) * (1 - src.g)
    const overlayB = dest.b < 0.5 ? 2 * dest.b * src.b : 1 - 2 * (1 - dest.b) * (1 - src.b)

    return {
      r:
        alpha === 0
          ? 0
          : (overlayR * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (overlayG * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (overlayB * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }
  ...
  protected compositePixel(
    ...
    return {
      r:
        alpha === 0
          ? 0
          : (darkenR * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (darkenG * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (darkenB * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }
  ...
  protected compositePixel(
    ...
    return {
      r:
        alpha === 0
          ? 0
          : (lightenR * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (lightenG * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (lightenB * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }
  ...
  protected compositePixel(
    ...
    return {
      r:
        alpha === 0
          ? 0
          : (dodgeR * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (dodgeG * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (dodgeB * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }
  ...
  protected compositePixel(
    ...
    return {
      r:
        alpha === 0
          ? 0
          : (burnR * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (burnG * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (burnB * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }
...
export class HardLightComposite extends BaseCompositeOperation {
  ...
  protected compositePixel(
    ...
    const hardLightR = src.r < 0.5 ? 2 * src.r * dest.r : 1 - 2 * (1 - src.r) * (1 - dest.r)
    const hardLightG = src.g < 0.5 ? 2 * src.g * dest.g : 1 - 2 * (1 - src.g) * (1 - dest.g)
    const hardLightB = src.b < 0.5 ? 2 * src.b * dest.b : 1 - 2 * (1 - src.b) * (1 - dest.b)

    return {
      r:
        alpha === 0
          ? 0
          : (hardLightR * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (hardLightG * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (hardLightB * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }
  ...
  protected compositePixel(
    ...
    return {
      r:
        alpha === 0
          ? 0
          : (softLightR * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (softLightG * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (softLightB * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }
  ...
  protected compositePixel(
    ...
    return {
      r:
        alpha === 0
          ? 0
          : (diffR * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (diffG * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (diffB * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }
  ...
  protected compositePixel(
    ...
    return {
      r:
        alpha === 0
          ? 0
          : (exclusionR * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (exclusionG * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (exclusionB * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }
