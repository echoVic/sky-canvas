  ...
  protected compositePixel(
    ...
    return {
      r:
        alpha === 0
          ? 0
          : (result.r * src.a + src.r * dest.a * invDestA + dest.r * src.a * invSrcA) / alpha,
      g:
        alpha === 0
          ? 0
          : (result.g * src.a + src.g * dest.a * invDestA + dest.g * src.a * invSrcA) / alpha,
      b:
        alpha === 0
          ? 0
          : (result.b * src.a + src.b * dest.a * invDestA + dest.b * src.a * invSrcA) / alpha,
      a: alpha,
    }
  }

  private rgbToHsl(color: { r: number; g: number; b: number; a: number }): {
    h: number
    s: number
    l: number
  } {
