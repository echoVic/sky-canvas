...
export interface ColorAdjustmentConfig extends PostProcessConfig {
  type: PostProcessType.BRIGHTNESS | PostProcessType.CONTRAST | PostProcessType.SATURATION | PostProcessType.HUE_SHIFT | PostProcessType.GAMMA | PostProcessType.EXPOSURE;
  parameters: {
    amount: number;
  };
}
