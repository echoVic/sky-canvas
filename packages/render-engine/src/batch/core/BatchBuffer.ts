...
import { type Buffer, BufferType } from '../../core/RenderTypes'
import type { WebGLResourceManager } from '../../resources/ResourceManager'
import type { BatchConfig, BatchVertex } from '../types/BatchTypes'
...
export class BatchBuffer {
  ...
  private initializeBuffers(): void {
    ...
    // 创建WebGL缓冲区
    this.vertexBuffer = this.resourceManager.createBuffer(BufferType.VERTEX, this.vertices.buffer)
    this.indexBuffer = this.resourceManager.createBuffer(BufferType.INDEX, this.indices.buffer)
  }
