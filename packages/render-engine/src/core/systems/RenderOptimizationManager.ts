...
export type { SystemStatus, OptimizationMetrics, OptimizationRecommendation } from './RenderOptimizationTypes';
...
export class RenderOptimizationManager extends BaseSystem {
  ...
  private setupSystemDependencies(): void {
    const pipelineScheduler = this.systems.get('pipeline-scheduler') as RenderPipelineScheduler | undefined;
