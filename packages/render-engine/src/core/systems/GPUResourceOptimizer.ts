...
import {
  ...
  type GPUMemoryStats,
  type GPUOptimizerConfig,
  type GPUResource,
  GPUResourceType,
  type TextureConfig,
} from './GPUResourceTypes'
import { type PoolStats, ResourcePool } from './ResourcePool'
...
export { type PoolStats, ResourcePool } from './ResourcePool'
...
export class GPUResourceOptimizer extends BaseSystem {
  ...
  private updateMemoryStats(type: GPUResourceType, sizeChange: number): void {
    ...
    this.stats.totalUsed =
      this.stats.textureMemory + this.stats.bufferMemory + this.stats.framebufferMemory
