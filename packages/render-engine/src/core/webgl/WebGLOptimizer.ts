...
export { DEFAULT_OPTIMIZER_CONFIG, createInitialOptimizationStats, createInitialWebGLState } from './WebGLOptimizerTypes';
export { ShaderCache, BufferPool, WebGLStateManager, RenderBatchOptimizer } from './WebGLOptimizerHelpers';
...
export class WebGLOptimizer extends EventEmitter<WebGLOptimizerEvents> {
  ...
  getDetailedStats(): {
    ...
    bufferPool: { totalBuffers: number; inUseBuffers: number; availableBuffers: number; totalMemory: number };
