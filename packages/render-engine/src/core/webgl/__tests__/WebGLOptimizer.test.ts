...
import { WebGLShaderManager, ShaderProgram } from '../ShaderManager';
...
// Mock shader source
const mockShaderSource: ShaderSource = {
  vertex: `
...
describe('WebGLOptimizer', () => {
  ...
  it('应该能够获取优化的着色器', async () => {
    const shader = await optimizer.getOptimizedShader(mockShaderSource, shaderManager);
