 ...
 * 提供常用的2D图形渲染着色器
 */
import { ExtendedShaderSource } from './types';

/**
 * 基础2D形状着色器
 */
export const BASIC_SHAPE_SHADER: ExtendedShaderSource = {
  name: 'basic_shape',
  version: '1.0.0',
  vertex: `
 ...
 * 纹理着色器
 */
export const TEXTURE_SHADER: ExtendedShaderSource = {
  name: 'texture',
  version: '1.0.0',
  vertex: `
    attribute vec2 a_position;
 ...
 * 单色着色器 - 用于单一颜色绘制
 */
export const SOLID_COLOR_SHADER: ExtendedShaderSource = {
  name: 'solid_color',
  version: '1.0.0',
  vertex: `
    attribute vec2 a_position;
 ...
 */
export const SDF_CIRCLE_SHADER: ExtendedShaderSource = {
  name: 'sdf_circle',
  version: '1.0.0',
  vertex: `
    attribute vec2 a_position;
 ...
 * SDF矩形着色器
 */
export const SDF_RECT_SHADER: ExtendedShaderSource = {
  name: 'sdf_rect',
  version: '1.0.0',
  vertex: `
    attribute vec2 a_position;
 ...
 * 批处理着色器（支持多纹理）
 */
export const BATCH_SHADER: ExtendedShaderSource = {
  name: 'batch',
  version: '1.0.0',
  vertex: `
    attribute vec2 a_position;
 ...
 * 后处理着色器 - 简单的色彩调整
 */
export const POST_PROCESS_SHADER: ExtendedShaderSource = {
  name: 'post_process',
  version: '1.0.0',
  vertex: `
    attribute vec2 a_position;
 ...
 * @returns 着色器源码或null
 */
export function getShaderSource(name: keyof typeof SHADER_LIBRARY): ExtendedShaderSource | null {
