...
import { ExtensionType, Extension, IExtension } from './systems/ExtensionSystem';
...
export class ArchitectureManager implements IExtension {
   ...
   * 检查循环依赖
   */
  private checkForCircularDependency(componentName: string, layer: 'gl' | 'core' | 'feature'): boolean {
