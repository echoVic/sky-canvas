...
export class GeometryUtils {
  ...
  static circleCircleCollision(
    circleA: ICircleGeometry,
    circleB: ICircleGeometry
  ...
  static rectRectCollision(rectA: IRectGeometry, rectB: IRectGeometry): IGeometryCollisionResult {
    ...
    if (GeometryUtils.boundsIntersect(boundsA, boundsB)) {
    ...
    return {
      hasCollision: false,
      distance: new Vector2(rectA.center.x, rectA.center.y).distance(
        new Vector2(rectB.center.x, rectB.center.y)
      ),
      normal: new Vector2(0, 0),
      penetration: 0,
