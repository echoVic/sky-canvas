...
export class Matrix3x3 {
  ...
  transformDirection(vector: Vector2): Vector2 {
    const e = this.elements
    return new Vector2(e[0] * vector.x + e[3] * vector.y, e[1] * vector.x + e[4] * vector.y)
  }
  ...
  static shear(x: number, y: number): Matrix3x3 {
    return new Matrix3x3(1, x, 0, y, 1, 0, 0, 0, 1)
  }
  ...
  static fromArray(arr: number[]): Matrix3x3 {
    ...
    return new Matrix3x3(arr[0], arr[3], arr[6], arr[1], arr[4], arr[7], arr[2], arr[5], arr[8])
  }
